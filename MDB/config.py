...
def get_arguments():
    ...
    parser.add_argument('--min_size',type=int,help='image minimal size at the coarser scale',default=24)#24
    parser.add_argument('--max_size', type=int,help='image minimal size at the coarser scale', default=400)#240
    ...
    parser.add_argument('--niter', type=int, default=3000, help='number of epochs to train per scale')
