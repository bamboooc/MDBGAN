...
import MDB.functions as functions
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_stages', type=int, help='how many stages to use for training', default=6)#6
    ...
    copytree(osp.join(current_path, "MDB"), osp.join(dir2save, "MDB"))
